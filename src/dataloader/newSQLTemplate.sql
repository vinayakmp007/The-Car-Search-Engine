...
YEAR INTEGER,
CONSTRAINT supplier_unique UNIQUE (MODEL_NAME,MAN_NAME,YEAR));
...
CREATE SEQUENCE IMAGE_ID_GEN_SEQ 
  START WITH 100000 
  INCREMENT BY 1;

CREATE OR REPLACE TRIGGER IMAGE_GEN_TRIG
BEFORE INSERT ON CAR_IMAGE
FOR EACH ROW
BEGIN
:NEW.IMAGE_ID :=IMAGE_ID_GEN_SEQ.NEXTVAL;
END;